...
public class ProductServiceImpl implements IProductService {
	...
	public List<Map<String, Object>> findAll() {
		//this.productDAO.findAllByNamedQuery(arg0, arg1)
		List<Map<String, Object>> products = this.productDAO.findBySqlAndNamedQuery("SQL_App_Score_1", null);
		return products;
	}
	 ...
	 * @return
	 */
	public List<Map<String, Object>> getProdImages(Integer productId) {
		List<Map<String, Object>> prodImages = this.productDAO.findBySqlAndNamedQuery("SQL_PRODUCT_2", new Object[]{productId});
		return prodImages;
	}
