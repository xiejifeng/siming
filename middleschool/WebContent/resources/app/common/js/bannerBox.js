...
//	height: 950,
//	width: 800,
//	img: web_path+"resources/app/common/imgs/banner.png"
//}, {
//	height: 1187,
//	width: 900,
//	img: web_path+"resources/app/common/imgs/banner1.png"
//}];
...
Slider.prototype.autoChange = function() {
	...
	var changeStr ="";
	var upIndex =1;
	var keeptime=self.list[0].keeptime;
	setInterval(function(){
	    if(index_change==self.list.length){
	    	changeStr ="-1";
	    	upIndex=index_change;
		 	index_change--;
	    	...
	    	if(upIndex>index_change){
	    		index_change--;
	    	}else{
	    		index_change++;
	    	}
	    }
	    self.goIndex(changeStr);
	 }, 1000*keeptime);
};
...
Slider.prototype.renderDOM = function() {
	...
	for(var i = 0; i < len; i++) {
		...
		$(li).attr("onclick",'Personal.advertisementImg_click("'+item['click_url']+'");');
