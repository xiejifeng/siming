...
<head>
	...
	<title></title>
	<script type="text/javascript" src="<%=path%>resources/app/dictionary/js/dictEdit.js"></script>
</head>
<body style="background: #FFFFFF;">
	...
	<form id="frm">
	    <div class="search">
			...
			<input type="hidden" id="categoryCode" name="category.categoryCode" value="${param.categoryCode }">
			<span class="red">*</span>
		</div>
		<div class="tableDiv">
