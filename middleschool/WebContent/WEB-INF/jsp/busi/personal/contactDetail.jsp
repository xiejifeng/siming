...
<section class="user-reg">
	<form action="<%=path%>appScore/exchange.html" method="post" name="form" onsubmit="return ScoreExchange.checkForm()">
		...
		<div class="form-group h-auto">
			...
			<p class="form-message">请填写完整收货信息</p></c:if></c:if>
			<div id="msg" style="display:none"><p class="form-message">请填写完整收货信息</p></div>
		</div>
		<div class="btn-wrap wrapper">
			<input type="hidden" name="productid" value="${productid}"/>
			<a class="btn-pro" onclick="form.submit()">确认</a>
		</div>
	</form>
</section>
