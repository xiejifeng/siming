...
(function($) {
				...
				for (var j = 0; j < _4f.length; j++) {
					...
					if (col.checkbox) {
						...
						if (col.field) {
							...
							col.boxWidth = $.boxModel ? (col.width - (_51
									.outerWidth() - _51.width())) : col.width;
	...
	function _clear(_tar){
		...
		opts.view.clerGrid.call(opts.view, _tar);
		if (opts.height == "auto") {
			_19(_tar);
		}
	}
...
//		if (opts.pagination) {
//			var obj="{'"+opts.paginationObject+".pageNumber':"+opts.pageNumber+",'"+opts.paginationObject+".pageSize':"+opts.pageSize+"}";
//			$.extend(_130, {
...
//		}
//		if (opts.sortName) {
//			var obj="{'"+opts.paginationObject+".sortName':'"+opts.sortName+"','"+opts.paginationObject+".sortOrder':'"+opts.sortOrder+"'}";
			$.extend(_130, {
						sort : opts.sortName,
