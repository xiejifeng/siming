...
(function($) {
	function _1(_2) {
		...
		$(_2).datagrid("getPanel").find("div.datagrid-body").unbind(
			...
			if (_d) {
				...
				$.data(this, "propertygrid", {
					options : $.extend({}, $.fn.propertygrid.defaults,
							$.fn.propertygrid.parseOptions(this), _a)
				});
			}
			_1(this);
		});
					...
					$.fn.datagrid.defaults.view,
					{
						render : function(_f, _10, _11) {
							...
							for (var i = 0; i < _17.length; i++) {
								...
								if (!_11) {
									_15.push("<span>");
									_15.push(_12.groupFormatter.call(_f,
											_18.fvalue, _18.rows));
									_15.push("</span>");
								}
								_15.push("</td>");
								...
								for (var j = 0; j < _18.rows.length; j++) {
									var cls = (_16 % 2 && _12.striped) ? "class=\"datagrid-row-alt\""
											: "";
									var _19 = _12.rowStyler ? _12.rowStyler
											.call(_f, _16, _18.rows[j]) : "";
									var _1a = _19 ? "style=\"" + _19 + "\""
											: "";
									_15.push("<tr datagrid-row-index=\"" + _16
											+ "\" " + cls + " " + _1a + ">");
									_15.push(this.renderRow.call(this, _f, _14,
											_11, _16, _18.rows[j]));
									_15.push("</tr>");
									_16++;
								}
						...
						onAfterRender : function(_1b) {
							...
							var _1d = $(_1b).datagrid("getPanel").find(
									"div.datagrid-view");
