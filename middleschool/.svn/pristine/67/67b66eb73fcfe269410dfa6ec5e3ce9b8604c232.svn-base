...
<script src="<%=path%>resources/busi/scoreflow/js/scoreflow.js"type="text/javascript"></script>
</head>
<body>
		<div class="search">
			<span>手机号：</span>
			...
			<input type="text" id="username" name ="username"class="inputUserName" />
			<span style="margin-left: 15px;">状态:</span>
			<input type="text" id="status" class="inputUserName" />
		...
		<div class="search">
			<input class="btnOrange" type="button" value="导出" id="export" />&nbsp;&nbsp;
			<input class="btnBlue" type="button" value="已发货" id="success" />&nbsp;&nbsp;
		</div>
</body>
</html>