...
<script type="text/javascript"src="<%=path%>resources/busi/advertisement/advertisement.js"></script>
</head>
<body>
			...
			<form id="editfrm" method="post">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td class="tdW200">
							<input type="text" name="click_url" id="click_url" class="inputW180" value="">
						</td>
						<td></td>
					  </tr>
					<tr>
					...
					<tr>
						...
						<td class="tdW200">
							<input type="text" name="priority" id="priority" class="inputW180" value="">
						</td>
						<td></td>
					</tr>
					<tr>
						...
						<td class="tdW200">
							<input type="text" name="keeptime" id="keeptime" class="inputW180" value="">
						</td>
						<td></td>
					</tr>
					<tr>
						...
						<td class="tdW200">
							<img alt="" id="pre_cover" style="height:100px; width:200px;"  src="">
						</td>
						<td>
					...
					<tr>
						<td colspan="3" style="text-align:center; padding-top:30px;">
							<a class="btnOrange0" id="saveAddAdvertisement">保存</a>
						</td>
					</tr>
					</tbody>
				</table>
