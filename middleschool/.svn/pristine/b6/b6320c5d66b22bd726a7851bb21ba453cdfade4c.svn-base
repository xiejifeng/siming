...
public class TeacherController extends AbstractController{
    ...
    @RequestMapping(value = "/teacherInit.do", method = RequestMethod.GET)
...
//    }
    ...
    @ResponseBody
    public PaginationData<Map<String, Object>> getUsersList(TeacherPaginationDTO PaginationDTO) {
        
        PaginationData<Map<String, Object>> paginationData = null;
        // 是否查询
        paginationData = this.service.findTeacherPagination(PaginationDTO);
      //判断查询出的数据是否为空
    ...
    public @ResponseBody int saveUser(TeacherPaginationDTO userDTO,@RequestParam(value="roleId") String roleId){
    ...
    public @ResponseBody int passCheck(String userIds){
        return this.service.doCheckeTeacherUser(userIds);
    }
