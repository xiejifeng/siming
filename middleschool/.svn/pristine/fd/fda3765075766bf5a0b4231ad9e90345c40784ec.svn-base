						...
						.resizable({
							...
							onResize : function(e) {
								if (_f == "north" || _f == "south") {
									...
									_17.css("left", e.pageX
											- $(_d).offset().left - _17.width()
											/ 2);
								}
								return false;
							},
							onStopResize : function() {
								$(">div.layout-split-proxy-v", _d).css(
										"display", "none");
								$(">div.layout-split-proxy-h", _d).css(
										"display", "none");
				...
				if (_24 == "north" && _25.expandNorth) {
					...
					if (_24 == "south" && _25.expandSouth) {
						...
						_25.south.panel("panel").animate(
								...
								function() {
									_2(_23);
									_25.south.panel("options").onExpand
											.call(_25.south);
								});
					}
				}
