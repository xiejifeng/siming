...
package cn.ffcs.txb.service.paper;
...
public interface IPaperService {
	...
	List<Map<String, Object>> getPaperInfoBySubjectId(String subjectd,Object userid);
	List<Map<String, Object>> getPaperInfoBySubjectId(String subjectd);
