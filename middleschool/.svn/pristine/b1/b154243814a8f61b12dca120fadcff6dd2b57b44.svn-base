...
<body>
	...
	<section class="login wrap">
		<form action="#" method="post">
			...
			<div class="form-group clearFix dis_none"  id="code_div">
			...
			<a ><a class=""  onclick="appLogin.login();" style="background: #00acf0; color: #fff;width:100%; height:1.18rem; border-radius:0.125rem; border: none; font-size: 0.5rem; display: inline-block; text-align: center; line-height: 1.18rem;">用户登录</a></a>
		</form>
		<div class="user-link">
			<a href="#" onclick="appLogin.userRegistry();">用户注册</a>
			<a onclick="Common.back(5,2);">继续答题</a>
